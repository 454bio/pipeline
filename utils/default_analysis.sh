...
ref_name=synth_GC23_26nt.fasta
...
python3 ${align_path}/align_reads.py --ref ${ref_path}/${ref_name} --in ${run_name}.fastq --out ${run_name}.txt --poslist 0,26,52,78 --direction 1 >> ${run_name}.log
